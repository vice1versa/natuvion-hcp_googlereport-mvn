...
public class ReportWriter {
	...
	/**
	 * The following examples copy an existing document.
	 * You can find the ID to use for the Drive API call in the URL of the document.
	 * rest api  call https://docs.google.com/document/d/document_id/edit
	 * @throws IOException 
	 */
	private void copyingExistingDocument(
